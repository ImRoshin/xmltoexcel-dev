...
public class XmlToExcelConverter {
    ...
    private static void getAndReadXml(int n) throws Exception {
        ...
        File xmlFile = new File("C:\\Users\\jkoilpillai\\intellij\\config\\config2.xml");
        ...
        while(n>0)
        {
            ...
            for (int i = 0; i < nList.getLength(); i++) {
                ...
                if (node.getNodeType() == Node.ELEMENT_NODE) {
                    ...
                    String Acquirer_s_Business_ID = element.getElementsByTagName("Acquirer_s_Business_ID").item(0).getTextContent();
                    ...
                    for (int j = 0; j < Merchant.getLength(); j++) {
                        ...
                        cell.setCellValue(Acquirer_s_Business_ID);
                        ...
                        cell.setCellValue(Destination_Amount);
        ...
        FileOutputStream fileOut = new FileOutputStream("C:\\Users\\jkoilpillai\\intellij\\config\\Clearing_Transactions_VISA_BASE.xlsx");
